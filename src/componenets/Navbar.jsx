...
function Navbar() {
  return (
    <nav className="bg-white border-200 dark:bg-gray-700">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFVSjIC23BpMpgkQ2OMVlDpMAXD3VSPleBs6coER7bXGINvBX_VKG1XteoNaJPv48gyPY&usqp=CAU"
        ...
        >
          ...
          <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-700 dark:border-gray-700">
            <li>
              <a
                href="#"
